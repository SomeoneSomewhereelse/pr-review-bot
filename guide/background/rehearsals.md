...
| **#4** | **First hosted run** (Render + Supabase, 2026-08-07) — happy path, `seed_demo_pr.py` against the deployed service | **~9.2s** PR-created → comment-appeared, real findings via groq; `tickets` created by the app's own first boot against a real Supabase project |
